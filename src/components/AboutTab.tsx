    ...
    <Card className="p-2">
      <CardBody>
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
          <Image alt="Avatar" className="" src="/pictures/me.jpg" />
          <div className="text-left md:text-left">
            ...
            <p className="text-md mt-4">
              My favorite tools include TypeScript, React, and Python. I also
              enjoy working with databases like PostgreSQL and MySQL. Here are
              the technologies I use most frequently:
            </p>
